...
str(EXCEPTION_OBJECT_ALREADY_LOCKED, 'This object is already in edition with another user');
str(EXCEPTION_OBJECT_ALREADY_LOCKED . '?description', 'This object is already in edition with another user');

str(EXCEPTION_OBJECT_CONVERT_PROPERTY_TO_OBJECT_FAILED, 'The property could not be converted into an object');
