...
(
    ...
    (
        ...
        STRING_NUMBER_PLURAL    => '设计',
        STRING_NUMBER_SINGULAR => '设计',
        STRING_CONSONANT => true
    )
);


$this->setString(null, null, null, '设计');
$this->setString(null, null, array('plural'), '设计');


// Disclaimers

$this->setString(STRING_DISCLAIMER, ACTION_DELETE, null, '你将要删除此设计，确定？');
...
$this->setString(STRING_PROPERTY, 'templates',  array('label'), '模板');
...
$this->setString(STRING_SECTION, 'about', null, '关于设计');
...
$this->setString(STRING_ACTION, 'view/preview', null, '预览');
$this->setString(STRING_ACTION, 'view/structure', null, '显示结构');
$this->setString(STRING_ACTION, 'search', array('placeholder'), '按名称搜索设计');
