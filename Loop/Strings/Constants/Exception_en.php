...
str(EXCEPTION_APPLICATION_BREAK, 'The application has been stopped');
str(EXCEPTION_APPLICATION_BREAK . '?description', 'A breakpoint has been set, which has led to the application being stopped.');
